...
console.log(
  "****************2) first and last element in array***************"
);
console.log("Given array :[20,31,40,25,23,11,29,9,60,2,11]");
...
console.log(
  "************6) sum of all even positioned elements in array************"
);
...
console.log(
  "************7) sum of all odd positioned elements in array************"
);
...
console.log(
  "************9) The number which are multiple of five is************"
);
...
console.log(
  "************13) Delete 3 element starting of index 4 :************"
);
